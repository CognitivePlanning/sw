Install Ocaml in linux Ubuntu and compile the modules to generated the binary files adapted to your system, following the next procedure :
...
You can manually delete these *.cmi files which are placed in ~/chatbot_master/planer/Sources and ~/chatbot_master/brev/Sources.
Then when you execute the "make" command these will be generated again. 

The "dune build" command will generate the file : main.exe in ~/chatbot_master/translator/_build/default/src/
